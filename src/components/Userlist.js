                ...
                {users.map(user => (
                    <div className="flex items-center bg-gray-100 mb-10 shadow" key={user.id}>
                        ...
                        <div className="flex-auto text-right px-4 py-2 m-2">
                            ...
                            <button onClick={() => removeUser(user.id)} className="block bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-full inline-flex items-center">
